...
> SvelteKit не исключает из предварительного рендеринга внешние ссылки относительно root-директории, что приведет к 404 ошибке, если эти URL-адреса предназначены для обслуживания отдельным приложением. Используйте пользовательский обработчик [`prerender.onError`](#konfiguracziya-prerender), если вам нужно их игнорировать.