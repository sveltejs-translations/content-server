...
3. Клиентское приложение должно *гидратировать* полученный с сервера HTML, прикрепляя обработчики событий и прочие штуки к существующим элементам, а не перерисовывать их полностью
